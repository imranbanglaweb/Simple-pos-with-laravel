...
function manageRow(data) {
	...
	$.each( data, function( key, value ) {
	  	rows = rows + '<tr>';
	  	rows = rows + '<td>'+value.e_name+'</td>';
        rows = rows + '<td>'+value.mother_name+'</td>';
        rows = rows + '<td>'+value.father_name+'</td>';
        rows = rows + '<td>'+value.present_address+'</td>';
        rows = rows + '<td>'+value.parmanent_address+'</td>';
        rows = rows + '<td>'+value.designation+'</td>';
        rows = rows + '<td>'+value.department+'</td>';
        rows = rows + '<td>'+value.mobile_number+'</td>';
