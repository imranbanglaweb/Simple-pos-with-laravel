...
<link rel="apple-touch-icon" sizes="60x60" href="{{url('public/Admin/')}}/app-assets/images/ico/apple-icon-60.png">
<link rel="apple-touch-icon" sizes="76x76" href="{{url('public/Admin/')}}/app-assets/images/ico/apple-icon-76.png">
<link rel="apple-touch-icon" sizes="120x120" href="{{url('public/Admin/')}}/app-assets/images/ico/apple-icon-120.png">
<link rel="apple-touch-icon" sizes="152x152" href="{{url('public/Admin/')}}/app-assets/images/ico/apple-icon-152.png">
<link rel="shortcut icon" type="image/x-icon" href="{{url('public/Admin/')}}/app-assets/images/ico/favicon.ico">
<link rel="shortcut icon" type="image/png" href="{{url('public/Admin/')}}/app-assets/images/ico/favicon-32.png">
...
<link rel="stylesheet" type="text/css" href="{{url('public/Admin/')}}/app-assets/css/pages/login-register.css">
<!-- END Page Level CSS-->
<!-- BEGIN Custom CSS-->
